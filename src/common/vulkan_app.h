    ...
    void buildCommandBuffers() override {
        ...
        for (int32_t i = 0; i < drawCmdBuffers.size(); ++i) {
            ...
            for (int j = 0; j < data.numberOfPoint; j++) {
                ...
                auto size = glm::vec3(0.05, 0.05, 0.05);
            ...
            {
                //{x=4.2261033926278788, y=-11.055798864521812, z=79.531298452093963}
                auto center = glm::vec3(4.2261033926278788, -11.055798864521812, 79.531298452093963);
                int step = 50;
                auto size = glm::vec3(0.5, 0.5, 0.5);
                double distance = 5;
                //x
                for (int k = 0; k < step; k++) {
                    auto pos = glm::vec3((center.x - distance * step / 2) + k * distance, -center.y, center.z);
                ...
                //y
                for (int k = 0; k < step; k++) {
                    auto pos = glm::vec3(center.x, -((center.y - distance * step / 2) + k * distance), center.z);
                ...
                //z
                for (int k = 0; k < step; k++) {
                    auto pos = glm::vec3(center.x, -center.y, (center.z - distance * step / 2) + k * distance);
