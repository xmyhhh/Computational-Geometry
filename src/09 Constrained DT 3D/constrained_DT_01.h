    ...
    struct PLC {
        ...
        VulkanDrawData toVulkanDrawData() {
            ...
            for (int i = 0; i < vertex_array.size(); i++) {
                vulkan_data.points[i * 3] = vertex_array[i].x * size;
                vulkan_data.points[i * 3 + 1] = -vertex_array[i].y * size;
                vulkan_data.points[i * 3 + 2] = vertex_array[i].z * size;
            }
